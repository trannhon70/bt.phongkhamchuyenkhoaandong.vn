 <footer id="footer" class="footer">
             ...
             <div class="footer_container-item">
                 <div class="footer_container-item-title">
                     <div class="footer_container-item-title-left">
                         <amp-img src="<?php echo $local ?>/images/logos/logo_footer.webp" height="60px" width="60px"
                             alt="..."></amp-img>
                     </div>
                 ...
                 <ul>
                     <li>
                         Địa chỉ: 360 An Dương Vương, P. Chợ Quán, TP. HCM
                     </li>
                     <li>
     ...
     <div class="footer__copy">
         <div class="footer__copy-body">
             Copyright © <?php echo date("Y") ?> Phòng khám Chuyên Khoa An Đông
         </div>
     </div>
 </footer>
 ...
 <div class="footer_list_icon">
     <div>
         <div class="footer_icon_happy" id="openModalKM">
             <amp-img src="<?php echo $local ?>/images/icons_chat/icon_happy.gif" height="50px" width="50px" alt="...">
             </amp-img>
         </div>
     </div>
